...
(defn simula-um-dia []
  ...
  ;Funciona, mas já começamos a sentir um treco no coraçao com
  ;esse simbolo global, com root binding sendo alteradp a rodo
...
(pprint hospital)
  ...
  (def hospital (h.logic/chega-em hospital :espera "8888"))
  (pprint hospital)
...
(defn simula-um-dia-em-parelelo
  []
  ; MUITO CLARO o problema de variavel global (simbolo do namespace) compartilhados por varias treads
  (def hospital (h.model/novo-hospital))
